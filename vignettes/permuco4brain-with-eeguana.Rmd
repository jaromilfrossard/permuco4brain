...
The EEG data [@nicenboim_eeg_2019] available on an Open Science Framework repository was analysed using the `eeguana` package. We will use the same dataset for the following tutorial.
