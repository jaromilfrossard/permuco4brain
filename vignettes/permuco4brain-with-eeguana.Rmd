...
vignette: >
  %\VignetteIndexEntry{permuco4brain-with-eeguana}
...
In the following analysis, we will mainly use function from the tidyverse [@wickham_tidyverse_2019], from eeguana [@nicenboim_eeguana_2020], from permuco [@frossard_permuco], from permuco4brain [@frossard_permuco4brain] and from igraph [@csardi_igraph]:
...
```{r plotgraph, echo=FALSE, message=FALSE, warning=FALSE, webgl=TRUE}
library(tidyverse)
library(eeguana)
library(permuco)
library(permuco4brain)
library(igraph)
library(rgl)
load("../data_vignettes/signal_design_graph.RData")
#igraph::rglplot(graph)
```
