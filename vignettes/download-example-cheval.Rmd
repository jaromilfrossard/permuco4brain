...
If your are not familiar with edf files, you can explore the first one using:
...
We download information about the subject and we keep only the measure of "Moderate to Vigorous Physical Activity" (MVPA) that we center:
...
We create the design from the filenames and we join the "between"-participant data. Moreover, we use only the "Round" stimuli as neutral shapes.
