...
To use multi-cores processing, we use the `plan()` function from the [`future` package](https://github.com/HenrikBengtsson/future). Finally, we run the permutation tests using: 
